  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        neon: "bg-transparent border-2 border-primary text-primary hover:bg-primary/10 rounded-lg shadow-[0_0_20px_hsl(var(--primary)/0.5)] hover:shadow-[0_0_30px_hsl(var(--primary)/0.6)]",
        hero: "bg-gradient-to-r from-[hsl(280,100%,70%)] to-[hsl(180,100%,50%)] text-[hsl(240,10%,4%)] font-semibold rounded-lg hover:shadow-[0_0_40px_hsl(280_100%_70%/0.5),0_0_80px_hsl(180_100%_50%/0.3)]",
        glass: "bg-[hsl(240_10%_4%/0.8)] backdrop-blur-xl border border-[hsl(240_10%_20%/0.5)] text-foreground hover:border-primary/50 hover:bg-secondary/50 rounded-lg",
      },
      size: {
